<template>
  <TitlesWithSmall :titleInfo="{'small': countResults(), title:'Сложение двузначных чисел'}"/>
...
export default {
  ...
  setup(props) {
    ...
    const results = ref(generateValue(rows.value, mathAction, props.mathData.minValue, props.mathData.maxValue, generateInterval));
